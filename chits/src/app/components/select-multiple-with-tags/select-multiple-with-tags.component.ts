...
@Component({
  selector: 'app-select-multiple-with-tags',
  templateUrl: './select-multiple-with-tags.component.html',
  styleUrls: ['./select-multiple-with-tags.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SelectMultipleWithTagsComponent),
      multi: true
    },
    {
...
export class SelectMultipleWithTagsComponent implements OnInit, AfterViewInit, OnDestroy, ControlValueAccessor {
