    ...
    !function(j) {
        ...
        t = function(e) {
            ...
            if (i < s + l)
                return !1;
            for (var a = -1; ++a < s; )
                if (t.charCodeAt(l + a) != n.charCodeAt(a))
                    return !1;
            return !0
        }
        ,
        ...
        var s = {
            useDefault: !1,
            _set: j.valHooks.select.set
        };
        j.valHooks.select.set = function(e, t) {
            return t && !s.useDefault && j(e).data("selected", !0),
        ...
        "4" === _.major && (Y.DIVIDER = "dropdown-divider",
        Y.SHOW = "show",
        Y.BUTTONCLASS = "btn-round btn-simple",
        ...
        function(e, t) {
            var i = this;
            s.useDefault || (j.valHooks.select.set = s._set,
            s.useDefault = !0),
            this.$element = j(e),
        ...
        function l(e) {
            ...
            !_.success) {
                ...
                Y.SHOW = "show",
                Y.BUTTONCLASS = "btn-round btn-simple",
                a.DEFAULTS.style = Y.BUTTONCLASS = "btn-round btn-simple",
                Y.POPOVERHEADER = "popover-header")
            }
            var t = this.each(function() {
                ...
                //         s.template = j.extend({}, a.DEFAULTS.template, j.fn.selectpicker.defaults ? j.fn.selectpicker.defaults.template : {}, e.data().template, i.template),
                //         e.data("selectpicker", t = new a(this,s))
                //     }
        ...
        "4" === _.major && (a.DEFAULTS.style = "btn-round btn-simple",
        a.DEFAULTS.iconBase = "",
        a.DEFAULTS.tickIcon = "bs-ok-default"),
        a.prototype = {
            constructor: a,
            init: function() {
                var i = this
            ...
            createDropdown: function() {
                var e = this.multiple || this.options.showTick ? " show-tick" : ""
                  ...
                  , n = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + q(this.options.liveSearchPlaceholder) + '"') + ' role="textbox" aria-label="Search"></div>' : ""
                  ...
                  , r = '<div class="dropdown bootstrap-select' + e + '"><button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + ("static" === this.options.display ? 'data-display="static"' : "") + 'data-toggle="dropdown"' + t + ' role="button"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner"></div></div> </div>' + ("4" === _.major ? "" : '<span class="bs-caret">' + this.options.template.caret + "</span>") + '</button><div class="' + Y.MENU + " " + ("4" === _.major ? "" : Y.SHOW) + '" role="combobox">' + i + n + s + '<div class="inner ' + Y.SHOW + '" role="listbox" aria-expanded="false" tabindex="-1"><ul class="' + Y.MENU + " inner " + ("4" === _.major ? Y.SHOW : "") + '"></ul></div>' + o + "</div></div>";
                return j(r)
            },
            ...
            createView: function(C, e) {
                ...
                var T, z, D = [];
                function i(e, t) {
                    var i, n, s, o, r, l, a, c, d, h = O.selectpicker.current.elements.length, p = [], u = void 0, f = !0, m = O.isVirtual();
                    ...
                    void 0 !== O.activeIndex && (z = O.selectpicker.current.elements[O.selectpicker.current.map.newIndex[O.prevActiveIndex]],
                    ...
                    t && (O.activeIndex !== O.selectedIndex && (D.classList.remove("active"),
                    D.firstChild && D.firstChild.classList.remove("active")),
                    O.activeIndex = void 0),
                    O.activeIndex && O.activeIndex !== O.selectedIndex && T && T.length && (T.classList.remove("active"),
                    T.firstChild && T.firstChild.classList.remove("active"))),
                    void 0 !== O.prevActiveIndex && O.prevActiveIndex !== O.activeIndex && O.prevActiveIndex !== O.selectedIndex && z && z.length && (z.classList.remove("active"),
                    z.firstChild && z.firstChild.classList.remove("active")),
                    (t || l) && (a = O.selectpicker.view.visibleElements ? O.selectpicker.view.visibleElements.slice() : [],
                    ...
                    f = !(c.length === d.length && c.every(function(e, t) {
                        return e === d[t]
                    }))),
                    (t || !0 === m) && f)) {
                        var b, w, x = O.$menuInner[0], I = document.createDocumentFragment(), k = x.firstChild.cloneNode(!1), y = !0 === m ? O.selectpicker.view.visibleElements : O.selectpicker.current.elements;
                        x.replaceChild(k, x.firstChild);
                        v = 0;
                        for (var E = y.length; v < E; v++)
                            I.appendChild(y[v]);
                ...
                j(window).off("resize.createView").on("resize.createView", function() {
                    i(O.$menuInner[0].scrollTop)
                })
            },
            createLi: function() {
                var T, z = this, D = [], H = 0, L = 0, A = [], N = 0, P = 0, R = -1;
                  ...
                  , V = function(e) {
                    ...
                    if (e.optionContent)
                        ...
                        e.optionIcon) {
                            ...
                            (i = B.span.cloneNode(!1)).className = z.options.iconBase + " " + e.optionIcon,
                            W.appendChild(i),
                            W.appendChild(s)
                        }
                        e.optionSubtext && ((t = B.subtext.cloneNode(!1)).innerHTML = e.optionSubtext,
                        n.appendChild(t))
                    }
                ...
                U.each(function(e) {
                    ...
                    !t.hasClass("bs-title-option")) {
                        var i, n, s = t.data(), o = this.className || "", r = q(this.style.cssText), l = s.content, a = this.textContent, c = s.tokens, d = s.subtext, h = s.icon, p = t.parent(), u = p[0], f = "OPTGROUP" === u.tagName, m = f && u.disabled, v = this.disabled || m, g = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName, b = p.data();
                        if (!0 === s.hidden || z.options.hideDisabled && (v && !f || m)) {
                            ...
                            g && "divider" !== A[A.length - 1].type && (R++,
                            D.push(M(!1, 0, Y.DIVIDER, N + "div")),
                            A.push({
                                type: "divider",
                                optID: N
                            }))
                            ...
                            if (f && !0 !== s.divider) {
                                ...
                                if (!this.previousElementSibling) {
                                    ...
                                    var $ = function(e) {
                                        ...
                                        e.labelIcon) {
                                            var s = B.whitespace.cloneNode(!1);
                                            (i = B.span.cloneNode(!1)).className = z.options.iconBase + " " + e.labelIcon,
                                            W.appendChild(i),
                                            W.appendChild(s)
                                        }
                                        return e.labelSubtext && ((t = B.subtext.cloneNode(!1)).textContent = e.labelSubtext,
                                        n.appendChild(t)),
                                        W.appendChild(n),
                                        W
                                    }({
                                    ...
                                    D.push(M($, 0, "dropdown-header" + x, N)),
                                    A.push({
                                        content: k,
                                        subtext: y,
                                        type: "optgroup-label",
                                ...
                                if (z.options.hideDisabled && v || !0 === s.hidden)
                                    return void R--;
                                n = V({
                                    text: a,
                                    optionContent: l,
                                ...
                                var S;
                                if (!g && z.options.hideDisabled)
                                    if (void 0 !== (i = s.prevHiddenIndex))
                                        (S = U[i].previousElementSibling) && "OPTGROUP" === S.tagName && !S.disabled && (g = !0);
                                g && "divider" !== A[A.length - 1].type && (R++,
                                D.push(M(!1, 0, Y.DIVIDER, N + "div")),
                                A.push({
                                    type: "divider",
                            ...
                            z.selectpicker.main.map.newIndex[e] = R,
                            z.selectpicker.main.map.originalIndex[R] = e;
                            var C = A[A.length - 1];
                            C.disabled = v;
                            var O = 0;
            ...
            render: function() {
                ...
                for (var s = 0, o = this.selectpicker.main.elements.length; s < o; s++) {
                    ...
                    if (r && r.selected && (i.push(r),
                    n.length < 100 && "count" !== e.options.selectedTextFormat || 1 === i.length)) {
                        if (e.options.hideDisabled && (r.disabled || "OPTGROUP" === r.parentNode.tagName && r.parentNode.disabled))
                            return;
                        var l, a, c = this.selectpicker.main.data[s].data, d = c.icon && e.options.showIcon ? '<i class="' + e.options.iconBase + " " + c.icon + '"></i> ' : "";
            ...
            liHeight: function(e) {
                if (e || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var m, v = a.offsetHeight, g = r ? r.offsetHeight : 0, b = d ? d.offsetHeight : 0, w = h ? h.offsetHeight : 0, x = p ? p.offsetHeight : 0, I = u ? u.offsetHeight : 0, k = j(o).outerHeight(!0), y = !!window.getComputedStyle && window.getComputedStyle(i), E = i.offsetWidth, $ = y ? null : j(i), S = {
                        ...
                        horiz: O(y ? y.paddingLeft : $.css("paddingLeft")) + O(y ? y.paddingRight : $.css("paddingRight")) + O(y ? y.borderLeftWidth : $.css("borderLeftWidth")) + O(y ? y.borderRightWidth : $.css("borderRightWidth"))
                    }, C = {
            ...
            getSelectPosition: function() {
                var e, t = j(window), i = this.$newElement.offset(), n = j(this.options.container);
            ...
            setMenuSize: function(e) {
                ...
                var t, i, n, s, o, r, l, a = this.sizeInfo.selectWidth, c = this.sizeInfo.liHeight, d = this.sizeInfo.headerHeight, h = this.sizeInfo.searchHeight, p = this.sizeInfo.actionsHeight, u = this.sizeInfo.doneButtonHeight, f = this.sizeInfo.dividerHeight, m = this.sizeInfo.menuPadding, v = 0;
            ...
            selectPosition: function() {
                ...
                var n, s, o, r = this, l = j(this.options.container), e = function(e) {
                    var t = {}
                    ...
                    (_.major < 4 || "static" === i) && (t.top = n.top - s.top + o,
                ...
                this.$button.on("click.bs.dropdown.data-api", function() {
                    ...
                    r.$bsContainer.appendTo(r.options.container).toggleClass(Y.SHOW, !r.$button.hasClass(Y.SHOW)).append(r.$menu))
                }),
                ...
                e.selectpicker.view.visibleElements && e.selectpicker.view.visibleElements.length)
                    for (var i = 0; i < e.selectpicker.view.visibleElements.length; i++) {
                        ...
                        if (s) {
                            ...
                            e.setDisabled(n, s.disabled || "OPTGROUP" === s.parentNode.tagName && s.parentNode.disabled, o, r),
                            e.setSelected(n, s.selected, o, r)
                        }
                    }
            },
            setSelected: function(e, t, i, n) {
                var s, o, r, l = void 0 !== this.activeIndex, a = this.activeIndex === e || t && !this.multiple && !l;
                ...
                this.activeIndex = e),
                r && (r.classList.toggle("selected", t),
                r.classList.toggle("active", a),
                r.setAttribute("aria-selected", t)),
                a || !l && t && void 0 !== this.prevActiveIndex && (s = this.selectpicker.main.map.newIndex[this.prevActiveIndex],
                (o = this.selectpicker.main.elements[s]).classList.toggle("selected", t),
                o.classList.remove("active"),
                o.firstChild && (o.firstChild.classList.toggle("selected", t),
            ...
            setDisabled: function(e, t, i, n) {
                ...
                s && ("4" === _.major && s.classList.toggle(Y.DISABLED, t),
            ...
            clickListener: function() {
                ...
                this.$newElement.on("show.bs.dropdown", function() {
                    3 < _.major && !E.dropdown && (E.dropdown = E.$button.data("bs.dropdown"),
                ...
                this.$menuInner.on("click", "li a", function(e, t) {
                    ...
                    !E.isDisabled() && !i.parent().hasClass(Y.DISABLED)) {
                            ...
                            !1 !== u || !1 !== f) {
                                ...
                                if (u && m || f && v)
                                    if (u && 1 == u) {
                                        ...
                                        x[2] && (I = I.replace("{var}", x[2][1 < u ? 0 : 1]),
                                        k = k.replace("{var}", x[2][1 < f ? 0 : 1])),
                                        c.prop("selected", !1),
                                        E.$menu.append(y),
                                        u && m && (y.append(j("<div>" + I + "</div>")),
                                        l = !1,
                                        E.$element.trigger("maxReached.bs.select")),
                                        f && v && (y.append(j("<div>" + k + "</div>")),
                                        l = !1,
                        ...
                        l && (o != $(E.$element[0]) && E.multiple || r != E.$element.prop("selectedIndex") && !E.multiple) && (S = [s, c.prop("selected"), o],
                ...
                this.$menu.on("click", "li." + Y.DISABLED + " a, ." + Y.POPOVERHEADER + ", ." + Y.POPOVERHEADER + " :not(.close)", function(e) {
                    ...
                    e.stopPropagation(),
                    E.options.liveSearch && !j(e.target).hasClass("close") ? E.$searchbox.focus() : E.$button.focus())
                }),
                ...
                this.$menu.on("click", ".actions-btn", function(e) {
                    ...
                    e.preventDefault(),
                    e.stopPropagation(),
                    j(this).hasClass("bs-select-all") ? E.selectAll() : E.deselectAll()
                }),
                this.$element.on({
                    change: function() {
                        E.render(),
                ...
                this.$searchbox.on("input propertychange", function() {
                    ...
                    e) {
                        ...
                        for (var l = 0; l < u.selectpicker.main.data.length; l++) {
                            ...
                            n[l] || (n[l] = y(a, i, o, r)),
                            n[l] && void 0 !== a.headerIndex && -1 === s.indexOf(a.headerIndex) && (0 < a.headerIndex && (n[a.headerIndex - 1] = !0,
            ...
            changeAll: function(e) {
                if (this.multiple) {
                    ...
                    for (var o = 0; o < this.selectpicker.current.elements.length; o++) {
                        ...
                        l && !l.disabled && "divider" !== r.type && (l.selected && i++,
                        l.selected = e,
                        l.selected && n++)
                    }
                    this.$element.removeClass("bs-select-hidden"),
            ...
            keydown: function(e) {
                var t, i, n, s, o, r = j(this), l = r.hasClass("dropdown-toggle"), a = (l ? r.closest(".dropdown") : r.closest(A.MENU)).data("this"), c = a.findLis(), d = !1, h = e.which === D && !l && !a.options.selectOnTab, p = N.test(e.which) || h, u = a.$menuInner[0].scrollTop, f = a.isVirtual(), m = !0 === f ? a.selectpicker.view.position0 : 0;
                ...
                p) {
                    ...
                    e.preventDefault();
                    var v = m + t;
                    e.which === H ? 0 === m && t === c.length - 1 ? (a.$menuInner[0].scrollTop = a.$menuInner[0].scrollHeight,
                    ...
                    for (var x = 0; x < a.selectpicker.current.data.length; x++) {
                        ...
                        y(I, b, "startsWith", !0) && a.selectpicker.view.canHighlight[x] && (I.index = x,
                        w.push(I.originalIndex))
                    }
                    if (w.length) {
                        var k = 0;
                        ...
                        d = 0 < u - (s = a.selectpicker.current.data[g]).position ? (o = s.position - s.height,
                        !0) : (o = s.position - a.sizeInfo.menuInnerHeight,
                        s.position > u + a.sizeInfo.menuInnerHeight),
                ...
                i && (e.which === z && !a.selectpicker.keydown.keyHistory || e.which === T || e.which === D && a.options.selectOnTab) && (e.which !== z && e.preventDefault(),
                a.options.liveSearch && e.which === z || (a.$menuInner.find(".active a").trigger("click", !0),
                r.focus(),
                a.options.liveSearch || (e.preventDefault(),
                j(document).data("spaceSelect", !0))))
            },
            mobile: function() {
        ...
        j.fn.selectpicker.noConflict = function() {
            return j.fn.selectpicker = h,
            this
        }
        ,
        j(document).off("keydown.bs.dropdown.data-api").on("keydown.bs.select", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bs-searchbox input', a.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bs-searchbox input', function(e) {
            e.stopPropagation()
        }),
    ...
    C.fn.extend({
        slimScroll: function($) {
            ...
            return this.each(function() {
                var n, e, s, i, o, r, l, a, c = "<div></div>", d = 30, h = !1, p = C(this);
                if (p.parent().hasClass(S.wrapperClass)) {
                    var u = p.scrollTop();
                    if (b = p.closest("." + S.barClass),
                    g = p.closest("." + S.railClass),
                    k(),
                    C.isPlainObject($)) {
                        if ("height"in $ && "auto" == $.height) {
                            ...
                            p.parent().css("height", f),
                            p.css("height", f)
                        }
                        if ("scrollTo"in $)
                            u = parseInt(S.scrollTo);
                        else if ("scrollBy"in $)
                            u += parseInt(S.scrollBy);
                        else if ("destroy"in $)
                            return b.remove(),
                            g.remove(),
                            void p.unwrap();
                    ...
                    var m = C(c).addClass(S.wrapperClass).css({
                        position: "relative",
                        overflow: "hidden",
                        width: S.width,
                        height: S.height
                    ...
                    var v, g = C(c).addClass(S.railClass).css({
                        width: S.size,
                        height: "100%",
                        position: "absolute",
                        top: 0,
                    ...
                    p.parent().append(b),
                    p.parent().append(g),
                    S.railDraggable && b.bind("mousedown", function(e) {
                        var i = C(document);
                        return s = !0,
                    ...
                    p.bind("touchmove", function(e) {
                        ...
                        e.originalEvent.touches.length) && (I((o - e.originalEvent.touches[0].pageY) / S.touchScrollStep, !0),
                        o = e.originalEvent.touches[0].pageY)
                    }),
                    k(),
                    "bottom" === S.start ? (b.css({
                        top: p.outerHeight() - b.outerHeight()
                    }),
                    I(0, !0)) : "top" !== S.start && (I(C(S.start).position().top, null, !0),
                    S.alwaysVisible || b.hide()),
                    v = this,
                    window.addEventListener ? (v.addEventListener("DOMMouseScroll", x, !1),
                    v.addEventListener("mousewheel", x, !1)) : document.attachEvent("onmousewheel", x)
                }
                function x(e) {
                    if (n) {
                        var t = 0;
                        ...
                        C(i).closest("." + S.wrapperClass).is(p.parent()) && I(t, !0),
                ...
                function I(e, t, i) {
                    ...
                    if (t && (n = parseInt(b.css("top")) + e * parseInt(S.wheelStep) / 100 * b.outerHeight(),
                    n = Math.min(Math.max(n, 0), s),
                    n = 0 < e ? Math.ceil(n) : Math.floor(n),
                    b.css({
                        top: n + "px"
                    })),
                    ...
                    p.scrollTop(n),
                    p.trigger("slimscrolling", ~~n),
                    y(),
                    E()
                }
                function k() {
                    r = Math.max(p.outerHeight() / p[0].scrollHeight * p.outerHeight(), d),
                    b.css({
                        height: r + "px"
                    });
                ...
                function y() {
                    ...
                    l == ~~l) {
                        ...
                        h = !1;
                    a = l,
                    r >= p.outerHeight() ? h = !0 : (b.stop(!0, !0).fadeIn("fast"),
                    S.railVisible && g.stop(!0, !0).fadeIn("fast"))
                }
                function E() {
                    S.alwaysVisible || (i = setTimeout(function() {
                        S.disableFadeOut && n || e || s || (b.fadeOut("slow"),
                        g.fadeOut("slow"))
                    }, 1e3))
                }
            }),
...
function(e, t) {
    ...
    var u = {
        ...
        show: function(e, t, i) {
            ...
            var s = h(t)
              , o = 0
              , r = 0;
            r = 0 <= (r = "touches"in e && e.touches.length ? (o = e.touches[0].pageY - s.top,
            e.touches[0].pageX - s.left) : (o = e.pageY - s.top,
            e.pageX - s.left)) ? r : 0,
            o = 0 <= o ? o : 0;
            ...
            c["-webkit-transition-duration"] = d + "ms",
            c["-moz-transition-duration"] = d + "ms",
            c["-o-transition-duration"] = d + "ms",
            c["transition-duration"] = d + "ms",
            n.setAttribute("style", p(c))
        },
        hide: function(e, t) {
            for (var i = (t = t || this).getElementsByClassName("waves-rippling"), n = 0, s = i.length; n < s; n++)
                o(e, t, i[n])
        }
    }
      , a = {
        input: function(e) {
            ...
            if ("i" !== t.tagName.toLowerCase() || !t.classList.contains("waves-effect")) {
                ...
                var n = window.getComputedStyle(e, null)
                  , s = n.color
                  , o = n.backgroundColor;
                i.setAttribute("style", "color:" + s + ";background:" + o),
    ...
    var c = {
        ...
        allowEvent: function(e) {
            var t = !0;
            return /^(mousedown|mousemove)$/.test(e.type) && c.touches && (t = !1),
            t
        },
        registerEvent: function(e) {
            var t = e.type;
            "touchstart" === t ? c.touches += 1 : /^(touchend|touchcancel)$/.test(t) && setTimeout(function() {
    ...
    function i(t) {
        ...
        if (null !== i) {
            if (i.disabled || i.getAttribute("disabled") || i.classList.contains("disabled"))
                return;
            if (c.registerEvent(t),
            "touchstart" === t.type && u.delay) {
                var n = !1
                ...
                u.show(t, i),
                l && (i.addEventListener("touchend", u.hide, !1),
    ...
    return t.init = function(e) {
        ...
        l && (t.addEventListener("touchstart", i, !1),
        t.addEventListener("touchcancel", c.registerEvent, !1),
        t.addEventListener("touchend", c.registerEvent, !1)),
    ...
    t.attach = function(e, t) {
        var i, n;
        e = d(e),
        "[object Array]" === r.call(t) && (t = t.join(" ")),
        t = t ? " " + t : "";
        for (var s = 0, o = e.length; s < o; s++)
            n = (i = e[s]).tagName.toLowerCase(),
            -1 !== ["input", "img"].indexOf(n) && (a[n](i),
            i = i.parentElement),
...
function() {
      ...
      , t = {
        request: function(o) {
            return new Promise(function(e, t) {
                var i, n = a.requestFullscreen, s = function() {
                    this.off("change", s),
                    e()
                }
                .bind(this);
                this.on("change", s),
                o = o || r.documentElement,
                i = / Version\/5\.1(?:\.\d+)? Safari\//.test(navigator.userAgent) ? o[n]() : o[n](l ? Element.ALLOW_KEYBOARD_INPUT : {}),
                Promise.resolve(i).catch(t)
            }
            .bind(this))
        },
        exit: function() {
    ...
    e ? (module.exports = t,
    module.exports.default = t) : window.screenfull = t) : e ? module.exports = !1 : window.screenfull = !1
}();
